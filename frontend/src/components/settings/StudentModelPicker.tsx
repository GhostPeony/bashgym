...
import { Zap, Loader2, CheckCircle, Cpu, Code, Flame } from 'lucide-react'
            ...
            >
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                ...
                {!isActive && (
                  ...
                  >
                    {isSetting ? <Loader2 className="w-3 h-3 animate-spin" /> : 'Use'}
                  </button>
                )}

                {isActive && <CheckCircle className="w-4 h-4 text-accent" />}
              </div>
            </div>
          )
        })}
