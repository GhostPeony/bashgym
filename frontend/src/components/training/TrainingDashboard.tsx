      ...
      <div className="mx-auto max-w-[1500px]">
        ...
        {activeTab === 'dashboard' && (
          <div className="grid grid-cols-12 gap-3">
            ...
            {currentRun && <div className="col-span-12 section-divider my-2" />}
              ...
              <div className="col-span-12 xl:col-span-6 card p-3">
                ...
                <div className="grid grid-cols-2 gap-2.5 text-sm">
                  ...
                  <div className="card p-2.5">
                    ...
                    <p className="font-brand text-base text-text-primary mt-0.5 truncate">
                      {currentRun.config.baseModel}
                    </p>
                  </div>
                  <div className="card p-2.5">
                    <span className="font-mono text-xs uppercase tracking-widest text-text-muted">
                    ...
                    <p className="font-brand text-base text-text-primary mt-0.5">
                      {currentRun.config.batchSize}
                    </p>
                  </div>
                  <div className="card p-2.5">
                    <span className="font-mono text-xs uppercase tracking-widest text-text-muted">
                    ...
                    <p className="font-brand text-base text-text-primary mt-0.5">
                      {currentRun.config.learningRate}
                    </p>
                  </div>
                  ...
                  {currentRun.config.selectedRepos &&
                    currentRun.config.selectedRepos.length > 0 && (
            ...
            <div
              className={clsx(
                'card p-3 col-span-12',
                currentRun ? 'xl:col-span-6' : 'xl:col-span-5'
              )}
            >
              <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-mono text-xs text-text-muted">
                            Generalist (all repos), Mixed (select repos), or Specialist (one repo)
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-mono text-xs text-text-muted">
                            Configure strategy (SFT, DPO, GRPO) and hyperparameters
                          </p>
                        </div>
                      </div>
                    </div>
