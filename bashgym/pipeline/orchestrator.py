...
class Pipeline:
    ...
    def __init__(
        ...
        self._watcher: ImportWatcher | None = None
    ...
    def handle_session_file(self, session_file: Path) -> dict[str, Any] | None:
        ...
        try:
            with open(result.destination_file, encoding="utf-8") as f:
